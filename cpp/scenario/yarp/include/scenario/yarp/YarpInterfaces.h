...
#ifndef SCENARIO_YARP_YARPINTERFACES_H
#define SCENARIO_YARP_YARPINTERFACES_H
...
class scenario::yarp::YarpInterfaces
{
public:
    YarpInterfaces() = delete;
    YarpInterfaces(const size_t dofs);
    ~YarpInterfaces();

    bool storeRCBR(::yarp::dev::PolyDriver* rcbr);
...
namespace scenario::yarp {
    ...
    template <>
    bool
    YarpInterfaces::getInterface(::yarp::dev::IPositionControl*& interface);
    template <>
    bool YarpInterfaces::getInterface(::yarp::dev::IPositionDirect*& interface);
    template <>
    bool
    YarpInterfaces::getInterface(::yarp::dev::IVelocityControl*& interface);
    template <>
...
#endif // SCENARIO_YARP_YARPINTERFACES_H
